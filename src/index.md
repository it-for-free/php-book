...
1. Введение
    1. [Первый скрипт на PHP](1._Vvedenie_v_php/1.1_Pervii_script_na_php.md)
    2. [PHP и HTML](1._Vvedenie_v_php/1.2_PHP_i_HTML.md)
    3. [Запуск PHP-скриптов в командной строке](1._Vvedenie_v_php/1.3_Zapusk_v_komandnoi_stroke.md)
    4. [Комментарии в скриптах](1._Vvedenie_v_php/1.4_Commentarii_v_scriptah.md)
    5. [Переменные: создание, интерполяция в строках, имена переменных в переменных](1._Vvedenie_v_php/1.5_Peremennie_sozdanie.md)
    6. [Константы и ключевые слова](1._Vvedenie_v_php/1.6_Konstanti_i_kluchevie_slova.md)
    7. [Типы данных](1._Vvedenie_v_php/1.7_Tipy_dannyh.md)
    8. [Итоги](1._Vvedenie_v_php/1.8_Itogi.md)
2. Операторы
    1.  [Математические операторы и функции](2._Operators/2.1_Matematicheskie_operatori_i_funcii.md)
    2.  [Операторы присваивания](2._Operators/2.2_Operatory-prisvaivaniya.md)
    3.  [Увеличение и уменьшение](2._Operators/2.3_Uvelichenie-i-umenshenie.md)
    4.  [Приоритет операторов](2._Operators/2.4_Prioritet-operatorovnie_1.md)
    5.  [Оператор исполнения](2._Operators/2.5_Operator-ispolneniya.md)
    6.  [Строковый оператор](2._Operators/2.6_Strokovye-operatory.md)
    7.  [Битовый оператор](2._Operators/2.7_Bitovye-operatory.md)
    8.  [Условный оператор](2._Operators/2.8_Uslovnyj-operator-if.md)
    9.  [Оператор сравнения](2._Operators/2.9_Operatory-sravneniya.md)
    10. [Логический оператор](2._Operators/2.10_Logicheskie-operatory.md)
    11. [Оператор ELSE](2._Operators/2.11_Operator-else.md)
    12. [Оператор ELSEIF](2._Operators/2.12_Onepatopelseif.md)
    13. [Тернарный оператор](2._Operators/2.13_Ternarnyj-operator.md)
    14. [Оператор SWITCH](2._Operators/2.14_Operator-switch.md)
    15. [Цикл FOR](2._Operators/2.15_Cikly-for.md)
    16. [Цикл WHILE](2._Operators/2.16_Cikly-while.md)
    17. [Цикл FOREACH](2._Operators/2.17_Cikly-foreach.md)
    18. [Оператор BREAK](2._Operators/2.18_Operator-break.md)
    19. [Оператор CONTINUE](2._Operators/2.19_Operator-continue.md)
    20. [Алтернативный синтаксис](2._Operators/2.20_Alternativnyj-sintaksis.md)
    21. [Итоги](2._Operators/2.21_Itogi.md)
3. Строки и массивы
    1.  [Функции обработки строк](3._Stroki-i-massivy/3.1_Funkcii-obrabotki-strok.md)
    2.  [Форматирование строк](3._Stroki-i-massivy/3.2_Formatirovanie-strok.md)
    3.  [Преобразование в строки и из строк](3._Stroki-i-massivy/3.3_Preobrazovanie-v-stroki-i-iz-strok.md)
    4.  [Создание массивов](3._Stroki-i-massivy/3.4_Sozdanie-massivov.md)
    5.  [Модификация элементов массива](3._Stroki-i-massivy/3.5_Modifikaciya-ehlementov-massiva.md)
    6.  [Удаление элементов массива](3._Stroki-i-massivy/3.6_Udalenie-ehlementov-massiva.md)
    7.  [Перебор элементов массива](3._Stroki-i-massivy/3.7_Perebor-ehlementov-massiva.md)
    8.  [Функции для работы с массивами](3._Stroki-i-massivy/3.8_Funkcii-dlya-raboty-s-massivami.md)
    9.  [Сортировка массивов](3._Stroki-i-massivy/3.9_Sortirovka-massivov.md)
    10. [Навигация по массивам](3._Stroki-i-massivy/3.10_Navigaciya-po-massivam.md)
    11. [Преобразование строк в массивы и наоборот](3._Stroki-i-massivy/3.11_Preobrazovanie-strok-v-massivyi-naoborot.md)
    12. [Извлечение переменных из массивов](3._Stroki-i-massivy/3.12_Izvlechenie-peremennyh-iz-massivov.md)
    13. [Слияние и разделение массивов](3._Stroki-i-massivy/3.13_Sliyanie-i-razdelenie-massivov.md)
    14. [Сравнение массивов](3._Stroki-i-massivy/3.14_Sravnenie-massivov.md)
    15. [Обработка данных в массивах](3._Stroki-i-massivy/3.15_Obrabotka-dannyh-v-massivah.md)
    16. [Многомерные массивы](3._Stroki-i-massivy/3.16_Mnogomernye-massivy.md)
    17. [Операторы над массивами](3._Stroki-i-massivy/3.17_Operatory-nad-massivami.md)
    18. [Итоги](3._Stroki-i-massivy/3.18_Itogi.md)
4. Функции
